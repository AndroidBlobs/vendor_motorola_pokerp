...
CUSTOM_HAL_IMGSENSOR = s5k3l6_sunwin_p161bn_mipi_raw sp2509v_sunwin_p161bn_mipi_raw s5k4h7yx_sunwin_p161m_mipi_raw s5k3l6_tsp_p161m_mipi_raw s5k4h7yx_tsp_p161m_mipi_raw
CUSTOM_HAL_LENS = dw9718saf_s5k3l6_sunwin_p161m dw9718saf_s5k3l6_tsp_p161m dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR = sp2509v_sunwin_p161bn_mipi_raw
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = 
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3l6_sunwin_p161bn_mipi_raw s5k3l6_tsp_p161m_mipi_raw
CUSTOM_HAL_MAIN_LENS = dw9718saf_s5k3l6_sunwin_p161m dw9718saf_s5k3l6_tsp_p161m
CUSTOM_HAL_MSENSORLIB = akm
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_BACKUP_LENS = 
CUSTOM_HAL_SUB_IMGSENSOR = s5k4h7yx_sunwin_p161m_mipi_raw s5k4h7yx_tsp_p161m_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = s5k3l6_sunwin_p161bn_mipi_raw sp2509v_sunwin_p161bn_mipi_raw s5k4h7yx_sunwin_p161m_mipi_raw s5k3l6_tsp_p161m_mipi_raw s5k4h7yx_tsp_p161m_mipi_raw
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9718saf_s5k3l6_sunwin_p161m dw9718saf_s5k3l6_tsp_p161m dummy_lens
CUSTOM_KERNEL_MAGNETOMETER = no
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR = sp2509v_sunwin_p161bn_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_LENS = 
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3l6_sunwin_p161bn_mipi_raw s5k3l6_tsp_p161m_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = dw9718saf_s5k3l6_sunwin_p161m dw9718saf_s5k3l6_tsp_p161m
...
CUSTOM_KERNEL_SUB_IMGSENSOR = s5k4h7yx_sunwin_p161m_mipi_raw s5k4h7yx_tsp_p161m_mipi_raw
...
CUSTOM_MODEM = p161_sp_lwctg_6177m_umoly0142_prod
...
#dong.wang add for enable fbe as default
...
#CJ see http://192.168.10.207/#/c/49945/2
...
#CJ ptgen will use this for M project partion
CUSTOM_BUILD_PTGEN_M = yes


####################
# content include from vendor/tinno/common/configs/TinnoProjectConfig.mk
AUTO_ADD_GLOBAL_TINNO_DEFINE_BY_NAME =
AUTO_ADD_GLOBAL_TINNO_DEFINE_BY_VALUE =
AUTO_ADD_GLOBAL_TINNO_DEFINE_BY_NAME_VALUE =


TINNO_PRJ_DIR=vendor/tinno/product/$(TINNO_TARGET_PROJECT)/$(ODM_PROJECT_NAME)

BUILD_GMS=yes
MTK_LOG_CUSTOMER_SUPPORT=yes

CONFIG_TINNO_GMAIL_SIGNATURE=no

#daming.cao ,PBGAM-348,add for remove this
FEATURE_LIGHT_CONTROL = yes

# TINNO BEGIN
# smartgestrue yan.lai
FEATURE_SMART_GESTURE = yes

#hide smart gesture menu
FEATURE_HIDE_GESTURE = no
# TINNO END
...
# TINNO BEGIN
# ApeSaleTracker shaowen.chen
FEATURE_APE_SALETRACKER = yes

#daming.cao ,PBGAM-348,add for remove this
#单手模式功能开关
FEATURE_SINGLE_HAND= no

#lijr add start 20180921
#智能截屏功能开关
FEATURE_SMART_SCREENSHOT = no
#配置设置中是否有三指截屏的开关，1表示没有，0表示有，对于不支持多点触控的项目，该值必须为1
CONFIG_TINNO_NO_MULTI_TOUCH = yes
#壁纸居中显示20181012
FEATURE_WallpaperCenter_SUPPORT = no
#关于手机界面，kernal version中的时区信息CST要改为WIB 20181023 MBA_FTR_KernalVersionTimezone_REQC347
FTR_KernalVersionTimezone_SUPPORT = no
#lijr end

#daming.cao ,PBGAM-348,add for remove this
FEATURE_NAVIGATIONBAR_SWITCH = no

#ApeSystemUpdateGOTA
FEATURE_APE_SYSTEM_UPDATE_GOTA = yes

FEATURE_QSMOBILEDATA_SWITCH = yes

MTK_PERSIST_PARTITION_SUPPORT = yes

# hsg for HAAPGO-999 LovelyFonts.apk会被谷歌认定为PHA，因此在系统中预置该apk会导致BTS测试fail项，需通过以下设置去除
LOVELYFONTS_SUPPORT = no
MTK_YIQI_FONTS_FRAMEWORK_SUPPORT = no

#TINNO BEGIN
#Added by fei.liu@tinno.com on Oct.16,2018 for restrict solution
FEATURE_TN_TPS_SUPPORT=no
#TINNO END

#默认用aosp的录音机
MTK_SOUNDRECORDER_APP = yes
MYOS_SOUNDRECORDER_APP = no

#智能待机开关, yes 表示开启, no 表示 关闭
FEATURE_SAVE_POWER=yes

# hsg 使系统支持通过白名单如：pms_sysapp_removable_system_list.txt, pms_sysapp_removable_product_list.txt等来设置可卸载的app
PMS_REMOVABLE_APP  = yes

# hsg for myos app begin
MYOS_APEFMRADIO = yes
MYOS_APEWEATHER = yes
MYOS_SMARTASSIST = yes
MYOS_MTBFTOOL = yes
# hsg for myos app end

#Added by wind.cheng for delay download when first boot
FEATURE_BOOT_DELAY_DOWNLOAD=yes
#TINNO BEGIN
#FEATURE_SINGLE_HAND suda 20180925
FEATURE_SINGLE_HAND = yes
#TINNO END

FEATURE_HAVE_HARDWARE_HALL = yes

#没有WMA licence,去掉wma相关配置,否则CTS fail,详见FAQ20735
MTK_WMA_PLAYBACK_SUPPORT=no

#FEATURE_CYCLING_MODE  shawn.yang  begin
FEATURE_CYCLING_MODE = no
#FEATURE_CYCLING_MODE  shawn.yang  end

#daichunwei add for PBGAM-536,we don't have CTA project start
MTK_CTA_SET = no
#daichuwnei add end

#CJ: see https://online.mediatek.com/FAQ#/SW/FAQ21471 , in default we are not CTA project . if any one need cta should enable this in it self config.
MTK_PRIVACY_PROTECTION_LOCK = no

#CJ: must be a new line at EOF


####################
# content include from vendor/tinno/product/p161bn/trunk/OdmProjectConfig.mk
# modify by wuhai for product build 20180831 begin
CUSTOM_BUILD_VERNO=PTB29.155
TCUSTOM_BUILD_VERNO=PTB29.155
INTERNAL_BUILD_VERNO=P160CN_PVT_9.0_LNV_64B_CFC_155.01-01

#add build for gms build
BUILD_GMS=yes


# enable SCM
FEATURE_TINNO_SCM = no

# enable SCC
FEATURE_TINNO_SCC = no

# Add for ApeAppLock by hai.qin
TINNO_FEATURE_APE_APPLOCK = no
#TINNO END


#TINNO BEGIN
#add by mingyue.wang for CDAAOB-248 DATE20171127
TINNO_FEATURE_SPN_NTTYPE_DISPLAY = no
#TINNO END

#chrome homepage
CONFIG_TINNO_CHROME_HOMEPAGE = no
...
#show google clientid
CONFIG_SHOW_CLIENTID = no

# TINNO BEGIN
# Add by qiaorong.wang for framework res,CDAAOB-432,DATE20171130
FEATURE_TINNO_FRAMEWORK_RES = no

CONFIG_TINNO_BATTERY_WARN = no
# TINNO END


#TINNO BEGIN
#xieqi add Tinno multimedia control all
FEATURE_MM_CONTROL_ALL = no

# TINNO BEGIN
# running background dexopt by marc.zhang, 2018.03.07
FEATURE_RUN_BACKGROUND_DEXOPT = no
# TINNO END


######################CMAS和ETWS两者不能同时开启########################################################
# caiyang add for wiko Cellbroadcast start
# 注意：开启宏MTK_CMAS_SUPPORT适用于wiko欧洲项目（wik_fr）即CMASReceiver.apk
MTK_CMAS_SUPPORT = no

# 注意：开启宏MTK_ETWS_SUPPORT适用于wiko亚洲项目（wik_id/wik_vn/wik_th等）即MtkCellBroadcastReceiver.apk
MTK_ETWS_SUPPORT = yes

# caiyang add for wiko Cellbroadcast end
#######################CMAS和ETWS两者不能同时开启#######################################################


CONFIG_TINNO_NO_MULTI_TOUCH = no

#TINNO BEGIN
#ID: MBA_FTR_UsbMode_REQC82
#DESCRIPTION: add for redefine usb connect modes
#AUTHOR: Ben.Hsu
PRODUCT_SYSTEM_DEFAULT_PROPERTIES += ro.feature.UsbMode=true
PRODUCT_SYSTEM_DEFAULT_PROPERTIES += ro.pt.usb.modes=charge,mtp,ptp
#TINNO END
# TINNO BEGIN
# lijian add for fingerprint 
TINNO_FINGERPRINT_SUPPORT = elan_688ra focaltech_ft9362
# TINNO END
# lijian add for double audioparam support
TINNO_DOU_AUD_PAR_SUPPORT = yes
# TINNO END

####################
# content include from ../modem/mcu/make/projects/p161bn_trunk/ProjectConfig.Modem.mk
# ../modem/mcu/make/projects/p161bn_trunk/ProjectConfig.Modem.mk is not found
